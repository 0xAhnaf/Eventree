...
const VendorGallerySection = () => {
  ...
  return (
    ...
    <section
      className="vendor-portfolio-section"
      id="gallery"
    >
      ...
      <p className="portfolio-description">
        ...
        Explore the curated experiences and memorable
        events hosted by this vendor. From elegant
        weddings to corporate celebrations, every event
